...
class CarouselUltraDetailingScreen extends StatelessWidget {
  ...
  final String image_url, profile_pic, d_description, profile_name, followers;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children:
              List.generate(Dummydb.carouselDetailingData.length, (index) {
            return Column(
              children: [
                Stack(children: [
                  Container(
